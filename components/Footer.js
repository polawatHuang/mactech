        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_.8fr_1fr_1.1fr]">
          <div>
            ...
            <p className="mt-5 max-w-[320px] text-sm leading-7 text-white/65">
              ผู้นำด้านการผลิต นำเข้า จัดจำหน่ายและศูนย์กระจายสินค้า แผงรั้วสำเร็จรูป แผงรั้วอุตสาหกรรม ลวด ตาข่ายและตะแกรงเหล็กแบบครบวงจร คุณภาพสูง ได้มาตรฐาน ทนทาน ตอบโจทย์ทุกกลุ่มการใช้งาน
            </p>
          </div>
